...
if (basename($_SERVER['PHP_SELF']) === 'login.php' && strpos($_SERVER['PHP_SELF'], '/views/auth/') !== false) {
    header("Location: " . ACTUAL_WEB_URL . "/auth/login.php");
    exit();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ACTUAL_WEB_URL; ?>/css/views/auth/login.css?v=1.0">
</head>
...
<body>
    ...
    <script src="<?php echo ACTUAL_WEB_URL; ?>/js/form_guards.js"></script>
    <script src="<?php echo ACTUAL_WEB_URL; ?>/js/views/auth/login.js"></script>
    ...
    <script>
        ...
        // Expose ACTUAL_WEB_URL to JS for absolute pathing
        window.ACTUAL_WEB_URL = '<?php echo ACTUAL_WEB_URL; ?>';
